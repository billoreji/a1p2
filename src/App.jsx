...
function App() {
  const user1 = { name: "shivani billore", email: "kTqZs@example.com" };
  const user2 = { name: "Shivani chouksey", age: 24, location: "Metropolis" };
  ...
  return (
    <>
      ...
      <ButtonClick1 />
      <ToggleButton />
      <Welcome1 name="Shivani Billore" />
      <Greeting message="I am Shivani" />
      <UserCard1 {...user1} />
      <ProfileCard {...user2} />
      <Card1>
